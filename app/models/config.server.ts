...
export const appwriteKey = process.env.APPWRITE_KEY as string;
...
export async function call(method: string, url: URL, headers: Headers = {}, params: Payload = {}): Promise<any> {
